...
public class Incident {
    ...
    private String videoUrl; // Path to processed video file
    
    @Column(columnDefinition = "TEXT")
    private String snapshotUrls; // JSON array of snapshot paths (before, during, after)
    
    @Column(name = "ai_report", columnDefinition = "LONGTEXT")
    private String aiReport; // Full AI analysis report
